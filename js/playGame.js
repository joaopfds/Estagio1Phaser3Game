class PlayGame extends Phaser.Scene
{
    ...
    {  
        ...
        this.o10 = 1;this.o11 = 1;this.o12 = 1;
        this.o13 = 1;this.o14 = 1;this.o15 = 1;
        this.inimigos = 15;
        ...
        this.ovni1 = this.physics.add.sprite(600, 530, 'ovni').setDepth(1);
        ...
        this.ovni10 = this.physics.add.sprite(4300, 550, 'ovni');
        this.ovni14 = this.physics.add.sprite(4500, 500, 'ovni');
        this.ovni15 = this.physics.add.sprite(5000, 600, 'ovni');
        ...
        this.tema = this.sound.add("tema", {volume: 0.6});
        this.tema.play();
    ...
    //-------------------------- disparos/Ataques ---------------------------------------
        ...
        if (this.tempo == this.timer){
            ...
            if(this.o14 == 0){
                this.balaOV = this.physics.add.sprite(this.ovni14.x, this.ovni14.y, 'bullet');
                this.balaOV.setVelocityX(-500);
            }
            if(this.o15 == 0){
                this.balaOV = this.physics.add.sprite(this.ovni15.x, this.ovni15.y, 'bullet');
                this.balaOV.setVelocityX(-500);
            }
    ...
    // ----------------------- colisao do tiro com os inimigos -----------------------------------
        ...
        this.physics.add.collider(this.bala, this.ovni14, this.hitDeath, null, this);
        this.physics.add.collider(this.bala, this.ovni15, this.hitDeath, null, this);
